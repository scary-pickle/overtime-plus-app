...
interface OnboardingState {
  ...
  // Actions
  checkOnboardingStatus: (userId?: string | null) => Promise<void>;
    ...
    try {
      ...
      if (userId) {
        try {
          ...
          console.log('Error checking Supabase onboarding status:', e);
    ...
    try {
      ...
      if (userId) {
        try {
          ...
          if (error) {
            console.log('Error updating Supabase onboarding status:', error);
            // Don't throw - local storage is sufficient
          }
        } catch (e) {
          console.log('Error updating Supabase onboarding status:', e);
          // Don't throw - local storage is sufficient
        }
      }
