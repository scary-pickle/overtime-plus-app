...
### Native Widgets & Live Activities
- [ ] ⬜ **Widget Status Updater**: Native module bridge for real-time widget updates (iOS App Groups / Android SharedPreferences)
  - [ ] ⬜ iOS: Implement UserDefaults bridge with App Groups
  - [ ] ⬜ Android: Implement SharedPreferences bridge
  - [ ] ⬜ Real-time shift status updates to widgets
  - See `lib/widget/widgetStatusUpdater.ts` for implementation details
